...
This section highlights the visualizations generated from principal component analysis with covariance.

### **1. Plotting Original Images**
This image displays the original dataset of facial images used for principal component analysis, providing a basis for further analysis.

<img src="https://github.com/rubythedev/principal-component-analysis/blob/main/images/original_faces.png" width="400">

### **2. Mean Face**
This image shows the mean face generated by averaging all faces in the dataset, providing a reference point for PCA analysis.

<img src="https://github.com/rubythedev/principal-component-analysis/blob/main/images/mean_face.png" width="400">

### **3. Elbow Plot**
The elbow plot visualizes the explained variance for each principal component. It helps identify the optimal number of components to retain based on the "elbow" point.

<img src="https://github.com/rubythedev/principal-component-analysis/blob/main/images/elbow_plot.png" width="400">

### **4. 50% Variance**
This image shows the data projected onto principal components that explain 50% of the variance, providing a partial view of the reduced dimensionality.

<img src="https://github.com/rubythedev/principal-component-analysis/blob/main/images/variance_50percent.png" width="400">

### **5. 70% Variance**
This projection represents the data using principal components that account for 70% of the total variance, capturing more detail from the original dataset.

<img src="https://github.com/rubythedev/principal-component-analysis/blob/main/images/variance_70percent.png" width="400">

### **6. 85% Variance**
Here, the data is projected onto principal components explaining 85% of the variance, retaining a significant portion of the original data’s information.

<img src="https://github.com/rubythedev/principal-component-analysis/blob/main/images/variance_80percent.png" width="400">

### **7. 95% Variance**
This image shows the data projected onto principal components that account for 95% of the variance, demonstrating a nearly complete reduction while preserving most of the original information.

<img src="https://github.com/rubythedev/principal-component-analysis/blob/main/images/variance_95percent.png" width="400">
